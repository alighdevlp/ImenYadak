                ...
                <div class="col-12 mb-3">
                    <div class="widget-search">
                        ...
                        <button class="btn-search-widget">
                            <img src="{{ url('front/img/theme/search.png') }}" alt="">
                        </button>
                    </div>
                </div>
                    ...
                    <div class="row mb-3 mx-0 px-res-0">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-12 px-10 mb-1 px-res-0">
                            <div class="product-card mb-2 mx-res-0">
                                ...
                                <a class="product-thumb" href="{{ route('product.show',$product->slug) }}">
                                    <img src="{{ url('/upload/products/' . $product->image) }}" alt="Product Thumbnail">
                                </a>
