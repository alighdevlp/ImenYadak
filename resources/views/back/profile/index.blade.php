                ...
                <div class="pl-0">
                    <div class="main-profile-overview">
                        ...
                        <div class="d-flex justify-content-between mg-b-20">
                            <div>
                                <h5 class="main-profile-name">{{ auth()->user()->name }} {{ auth()->user()->family }}</h5>
                    ...
                    <div class="card-body">
                        <div class="counter-status d-flex md-mb-0">
                            ...
                            <div class="ms-auto">
                                ...
                                <h2 class="mb-0 tx-22 mb-1 mt-1">{{ $products_count }}</h2>
                                <p class="text-muted mb-0 tx-11"><i
                                        class="si si-arrow-up-circle text-success mr-1"></i> افزایش دادن </p>
                            </div>
                        </div>
            ...
            <div class="card-body">
                <div class="tabs-menu ">
                    ...
                    <ul class="nav nav-tabs profile navtab-custom panel-tabs">
                        <li class="active">
                            <a href="{{ route('admin.products.index') }}" data-toggle="tab" aria-expanded="true"> <span class="visible-xs"><i
                            ...
                            <div class="col-sm-4">
                                <div class="border p-1 card thumb">
                                    <a href="#" class="image-popup" title="تصویر -2"> <img
                                            src="{{ url('/upload/products/' . $product->image) }}" class="thumb-img" alt="کار-تصویر کوچک">
                                    </a>
                                    <a href="{{ route('admin.products.show',$product->id) }}" class="mb-2"><h4 class="text-center tx-14 mt-3 mb-0">{{ $product->title }}</h4></a>
