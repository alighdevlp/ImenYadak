    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 ms-2 mb-0">/ ایجاد ویژگی</span>
            </div>
        </div>
    </div>
@endsection
        ...
        <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
            <div class="card  box-shadow-0">
                <div class="card-header">
                    <h4 class="card-title mb-1">فرم ایجاد ویژگی</h4>
                </div>
                <div class="card-body pt-0">
                    <form action="{{ route('admin.attributes.store') }}" class="form-horizontal" enctype="multipart/form-data"
                        method="POST">
                        @csrf
