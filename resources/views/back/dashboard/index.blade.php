    ...
    <div class="row row-sm">
        <div class="col-md-12 col-lg-12 col-xl-7">
            <div class="card">
                <div class="card-header bg-transparent pd-b-0 pd-t-20 bd-b-0">
                    ...
                    <p class="tx-12 text-muted mb-0">وضعیت سفارش و پیگیری. سفارش خود را از تاریخ کشتی تا
                        رسیدن پیگیری کنید. برای شروع ، شماره سفارش خود را وارد کنید.</p>
                </div>
                <div class="card-body">
        ...
        <div class="col-lg-12 col-xl-5">
            <div class="card card-dashboard-map-one">
                ...
                <span class="d-block mg-b-20 text-muted tx-12">عملکرد فروش کلیه ایالت ها در ایالات
                    متحده</span>
                <div class="">
        ...
        <div class="col-xl-4 col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header pb-1">
                    ...
                    <p class="tx-12 mb-0 text-muted">مشتری شخصی یا شغلی است که خدمات کالا را خریداری می
                        کند و شامل زمان واقعی می شود</p>
                </div>
                <div class="card-body p-0 customers mt-1">
                    <div class="list-group list-lg-group list-group-flush">
                        <div class="list-group-item list-group-item-action" href="#">
                            <div class="media mt-0">
                                <img class="avatar-lg rounded-circle ml-3 my-auto" src="assets/img/faces/3.jpg"
                                    alt="توضیحات تصویر">
                                <div class="media-body">
                                    <div class="d-flex align-items-center">
                                        <div class="mt-0">
                                            <h5 class="mb-1 tx-15">سامانتا خربزه</h5>
                                            <p class="mb-0 tx-13 text-muted">شناسه کاربر: # 1234 <span
                                                    class="text-success ml-2">پرداخت شده است</span></p>
                                        </div>
                        ...
                        <div class="list-group-item list-group-item-action" href="#">
                            <div class="media mt-0">
                                <img class="avatar-lg rounded-circle ml-3 my-auto" src="assets/img/faces/11.jpg"
                                    alt="توضیحات تصویر">
                                <div class="media-body">
                                    <div class="d-flex align-items-center">
                                        <div class="mt-1">
                                            <h5 class="mb-1 tx-15">جیمی چانگا</h5>
                                            <p class="mb-0 tx-13 text-muted">شناسه کاربری: # 1234 <span
                                                    class="text-danger ml-2">در انتظار</span></p>
                                        </div>
                                        <span class="mr-auto wd-45p fs-16 mt-2">
                        ...
                        <div class="list-group-item list-group-item-action" href="#">
                            <div class="media mt-0">
                                <img class="avatar-lg rounded-circle ml-3 my-auto" src="assets/img/faces/17.jpg"
                                    alt="توضیحات تصویر">
                                <div class="media-body">
                                    <div class="d-flex align-items-center">
                                        <div class="mt-1">
                        ...
                        <div class="list-group-item list-group-item-action" href="#">
                            <div class="media mt-0">
                                <img class="avatar-lg rounded-circle ml-3 my-auto" src="assets/img/faces/15.jpg"
                                    alt="توضیحات تصویر">
                                <div class="media-body">
                                    <div class="d-flex align-items-center">
                                        <div class="mt-1">
                        ...
                        <div class="list-group-item list-group-item-action br-br-7 br-bl-7" href="#">
                            <div class="media mt-0">
                                <img class="avatar-lg rounded-circle ml-3 my-auto" src="assets/img/faces/6.jpg"
                                    alt="توضیحات تصویر">
                                <div class="media-body">
                                    <div class="d-flex align-items-center">
                                        <div class="mt-1">
                                            <h5 class="mb-1 tx-15">سوزن های شارون</h5>
                                            <p class="b-0 tx-13 text-muted mb-0">شناسه کاربر: # 1234 <span
                                                    class="text-success ml-2">پرداخت شده است</span></p>
                                        </div>
                                        <span class="mr-auto wd-45p fs-16 mt-2">
        ...
        <div class="col-xl-4 col-md-12 col-lg-6">
            <div class="card">
                <div class="card-header pb-1">
                    ...
                    <p class="tx-12 mb-0 text-muted">فعالیت های فروش ، تاکتیک هایی است که فروشندگان برای
                        دستیابی به اهداف و هدف خود استفاده می کنند</p>
                </div>
                <div class="product-timeline card-body pt-2 mt-1">
                    <ul class="timeline-1 mb-0">
                        <li class="mt-0"> <i class="ti-pie-chart bg-primary-gradient text-white product-icon"></i>
                            <span class="font-weight-semibold mb-4 tx-14 ">تعداد کل محصولات </span> <a href="#"
                                class="float-left tx-11 text-muted">3 روز پیش</a>
                            <p class="mb-0 text-muted tx-12">1.3k محصولات جدید</p>
                        </li>
                        <li class="mt-0"> <i
                                class="mdi mdi-cart-outline bg-danger-gradient text-white product-icon"></i>
                            <span class="font-weight-semibold mb-4 tx-14 ">فروش کل </span> <a href="#"
                                class="float-left tx-11 text-muted">35 دقیقه قبل</a>
                        ...
                        <li class="mt-0"> <i class="ti-bar-chart-alt bg-success-gradient text-white product-icon"></i>
                            <span class="font-weight-semibold mb-4 tx-14 ">درآمد تواتال </span> <a href="#"
                                class="float-left tx-11 text-muted">50 دقیقه پیش</a>
                        ...
                        <li class="mt-0"> <i class="ti-wallet bg-warning-gradient text-white product-icon"></i> <span
                                ...
                                class="float-left tx-11 text-muted">1 ساعت پیش</a>
                        ...
                        <li class="mt-0"> <i class="si si-eye bg-purple-gradient text-white product-icon"></i> <span
                                class="font-weight-semibold mb-4 tx-14 ">بازدید مشتری </span> <a href="#"
                                class="float-left tx-11 text-muted">1 روز پیش</a>
                        ...
                        <li class="mt-0 mb-0"> <i class="icon-note icons bg-primary-gradient text-white product-icon"></i>
                            <span class="font-weight-semibold mb-4 tx-14 ">نظرات مشتری </span> <a href="#"
                                class="float-left tx-11 text-muted">1 روز پیش</a>
        ...
        <div class="col-xl-4 col-md-12 col-lg-6">
            <div class="card">
                <div class="card-header pb-0">
                    ...
                    <p class="tx-12 mb-0 text-muted">سفارش ، دستورالعمل های سرمایه گذار برای خرید یا فروش
                        به کارگزار یا کارگزاری است</p>
                </div>
                <div class="card-body sales-info ot-0 pt-0 pb-0">
                    <div id="chart" class="ht-150"></div>
                    <div class="row sales-infomation pb-0 mb-0 mx-auto wd-100p">
                        <div class="col-md-6 col">
                            <p class="mb-0 d-flex"><span class="legend bg-primary brround"></span>تحویل
                                داده شده</p>
                        ...
                        <div class="col-md-6 col">
                            <p class="mb-0 d-flex"><span class="legend bg-info brround"></span>لغو شد
                            </p>
